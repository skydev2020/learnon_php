<?php   
class ControllerTutorDashboard extends Controller {   
	public function index() {
    	$this->load->language('tutor/dashboard');
		...
		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => HTTPS_SERVER . 'index.php?route=tutor/dashboard&token=' . $this->session->data['token'],
		...
		$this->template = 'tutor/dashboard.tpl';
		$this->children = array(
			'common/header',	
			'common/footer'	
		);
