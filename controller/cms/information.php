<?php
class ControllerCmsInformation extends Controller { 
	private $error = array();
	
	public function student() {
		$this->language->load('cms/information');
		...
		$this->document->breadcrumbs = array();
      	...
      	$this->document->breadcrumbs[] = array(
        	'href'      => HTTPS_SERVER . 'index.php?route=cms/information/student',
        	'text'      => $this->language->get('text_student_help'),
        	'separator' => $this->language->get('text_separator')
      	);
    	
    	$information_info = $this->model_cms_information->getInformation('7');
    	
//    	print_r($information_info);
    	
    	$this->data['heading_title'] = $this->language->get('text_student_help');
	...
	public function tutor() {
		...
		$this->document->breadcrumbs = array();
      	...
      	$this->document->breadcrumbs[] = array(
        	'href'      => HTTPS_SERVER . 'index.php?route=cms/information/tutor&token=' . $this->session->data['token'],
        	'text'      => $this->language->get('text_student_help'),
        	'separator' => $this->language->get('text_separator')
      	);
    	
    	$information_info = $this->model_cms_information->getInformation('9');
    	
//    	print_r($information_info);
    	
    	$this->data['heading_title'] = $this->language->get('text_tutor_help');

    	$this->data['text_message'] = html_entity_decode($information_info['description'], ENT_QUOTES, 'UTF-8');
		
    	$this->data['button_continue'] = $this->language->get('button_continue');
		
		$this->data['continue'] = HTTPS_SERVER . 'index.php?route=account/account&token=' . $this->session->data['token'];
		
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/tutor/help.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/tutor/help.tpl';
		} else {
			$this->template = 'tutor/help.tpl';
		}
	...
	public function manager() {
    	...
    	$information_info = $this->model_cms_information->getInformation('11');
...
//    	print_r($information_info);
	...
	public function administrator() {
    	...
    	$information_info = $this->model_cms_information->getInformation('10');
...
//    	print_r($information_info);
	...
	private function validateForm() {
		...
		if (strlen(utf8_decode($this->request->post['title'])) < 3) {
