...
class ControllerUserUser extends Controller {  
	...
	private function getForm() {
		...
		$curr_user_group_id = $this->user->getUserGroupId();
		
		$all_user_groups =  $this->model_user_user_group->getUserGroups();
		
		foreach($all_user_groups as $key => $each_group) {
			if($each_group['user_group_id'] > $curr_user_group_id) {
				unset($all_user_groups[$key]);	
			}
		}
