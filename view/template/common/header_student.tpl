...
<div id="menu">
  <ul class="nav left" style="display: none;">
    ...
    <li id="mytutors"><a href="<?php echo $mytutors; ?>" class="top"><?php echo $text_mytutors; ?></a></li>
    <li id="invoice"><a href="<?php echo $invoices; ?>" class="top"><?php echo $text_invoice; ?></a></li>
    <?php if($parent_id==0) {?>
    <li id="children"><a href="<?php echo $childrens; ?>" class="top"><?php echo $text_children; ?></a></li>
    <?php } ?>    
...
function SwitchProfile(url) {
	if (url!="") {
		window.location = url+"&token=<?php echo $token; ?>";
	}
}
//--></script>
</div>
...
<?php } ?>
<?php if ($switch_str) {?>
<div id="switch" style="float:right;margin-top:-32px;color:#fff;">
	<select name="profiles" onchange="SwitchProfile(this.value)">
