...
<div class="box">
  ...
  <div class="content">
        ...
        <div style="background: #FCFCFC; border: 1px solid #8EAEC3; padding: 10px; ">
          <table border="0" cellpadding="2" style="width: 100%;">
            ...
            <tr>
             ...
             <tr>
              <td colspan="2"><?php echo $text_hours_message; ?></td>
            </tr>
    ...
    <div style="display: inline-block; width: 100%; margin-bottom: 15px; clear: both;">
      <div style="float: left; width: 49%;">
        <div style="background: #668EC1; color: #FFF; border-bottom: 1px solid #8EAEC3; padding: 5px; font-size: 14px; font-weight: bold;"><?php echo $text_active_packages; ?></div>
        <div style="background: #FCFCFC; border: 1px solid #8EAEC3; padding: 10px; height: 210px;">
        <table class="list">
          <thead>
            <tr>
              <td class="left"><?php echo $column_package_name; ?></td>
              <td class="center"><?php echo $column_total_hours; ?></td>
              <td class="right"><?php echo $column_hours_left; ?></td>
            </tr>
          </thead>
          <tbody>
            <?php foreach ($active_packages as $each_packages) { ?>
            <tr>          
              <td class="left"><?php echo $each_packages['package_name']; ?></td>
              <td class="right"><?php echo $each_packages['total_hours']; ?></td>
			  <td class="right"><?php echo $each_packages['left_hours']; ?></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
