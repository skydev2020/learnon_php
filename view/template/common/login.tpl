<?php echo $header; ?><br /><br /><br />
<div class="box" style="width: 325px; min-height: 200px; margin-top: 40px; margin-left: auto; margin-right: auto;">
  <div class="left"></div>
  <div class="right"></div>
  <div class="heading">
  ...
  <div class="content" style="min-height: 150px;">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table style="width: 100%;" border="0" align="left">
		...
		<tr>
          <td><a href="index.php?route=account/create/student">Student Registration</a></td>
          <td><a href="index.php?route=account/forgotten">Forgot Password?</a></td>
        </tr>        
