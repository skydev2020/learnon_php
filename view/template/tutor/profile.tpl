...
<div class="box">
  ...
  <div class="heading">
    ...
    <div class="buttons"><a onclick="$('#profile').submit();" class="button"><span><?php echo $button_continue; ?></span></a></div>
  </div>
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="profile">
      <table class="form">
        <tr>
        ...
        <tr>
          <td colspan="2" align="center"><a onclick="$('#profile').submit();" class="button"><span><?php echo $button_continue; ?></span></a></td>
        </tr>
      </table>
    </form>
  </div>
