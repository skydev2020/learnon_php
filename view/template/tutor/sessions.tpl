...
<div class="box">
  ...
  <div class="heading">
    ...
    <div class="buttons"><!-- <a onclick="location = '<?php echo $official_submit; ?>'" class="button"><span><?php echo $button_submit; ?></span></a>--> <a onclick="location = '<?php echo $insert; ?>'" class="button"><span><?php echo $button_insert; ?></span></a><a onclick="$('form').attr('action', '<?php echo $delete; ?>'); $('form').submit();" class="button"><span><?php echo $button_delete; ?></span></a></div>
  </div>
  <div class="content">
      ...
      <table class="list">
        ...
        <tbody>
          <tr class="filter">
            ...
            <td><input type="text" name="filter_session_date" value="<?php echo $filter_session_date; ?>" size="12" id="date" /></td>
            ...
            <td><input type="text" name="filter_session_notes" value="<?php echo $filter_session_notes; ?>" /></td>
...
function filter() {
	url = 'index.php?route=tutor/sessions&token=<?php echo $token; ?>';
