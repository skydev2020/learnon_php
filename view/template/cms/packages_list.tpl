      ...
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="left"><?php if ($sort == 'name') { ?>
              ...
              <?php } ?></td>
			<td class="left"><?php if ($sort == 'grades') { ?>
              <a href="<?php echo $sort_grades; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_grades; ?></a>
              <?php } else { ?>
              <a href="<?php echo $sort_grades; ?>"><?php echo $column_grades; ?></a>
              <?php } ?></td>
            ...
            <td class="right"><?php if ($sort == 'price_alb') { ?>
              ...
              <?php } ?></td>
            <td class="right"><?php if ($sort == 'student') { ?>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="left"><?php echo $information['grades']; ?></td>
            ...
            <td class="right"><?php echo $information['student']; ?></td>            
