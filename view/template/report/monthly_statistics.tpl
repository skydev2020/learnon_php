      ...
      <table class="list">
        <thead>
          <tr>
			 ...
			 <td class="right">              
			  <?php echo $column_monthly_tutoring_revenue; ?>			  
             </td> 
			  
			  <td class="right">
			   <?php echo $column_monthly_essay_revenue; ?>
			  </td> 
			  
			  <td class="right">
			   <?php echo $column_monthly_other_revenue; ?>
			  </td> 		  
            ...
            <td class="right"><?php echo $column_total_payroll; ?></td>
			  
            <td class="right"><?php echo $column_other_expenses; ?></td>
			  
            <td class="right"><?php echo $column_total_expenses; ?></td>
        ...
        <tbody>
          ...
          <tr>
            <td class="right">$ <?php echo $payment['tutoring_revenue']; ?></td>
			<td class="right">$ <?php echo $payment['assignment_revenue']; ?></td>
			<td class="right">$ <?php echo $payment['other_revenue']; ?></td>
			<td class="right">$ <?php echo $payment['total_revenue']; ?></td>
            <td class="right">$ <?php echo $payment['payroll']; ?></td>
			<td class="right">$ <?php echo $payment['other_expense']; ?></td>
            <td class="center">$ <?php echo $payment['total_expenses']; ?></td>
			<td class="right">$ <?php echo $payment['total_profit']; ?></td>
			<td class="right"><?php echo $payment['no_of_students']; ?></td>
            <td class="center"><?php echo $payment['no_of_tutors']; ?></td>
