...
<div class="box">
  ...
  <div class="content">
    <div id="tabs" class="htabs"><a tab="#tab_general"><?php echo $tab_general; ?></a><a tab="#tab_store"><?php echo $tab_store; ?></a><a tab="#tab_wages"><?php echo $tab_wages; ?></a><a tab="#tab_subject"><?php echo $tab_subject; ?></a><a tab="#tab_grade"><?php echo $tab_grade; ?></a><a tab="#tab_local"><?php echo $tab_local; ?></a><a tab="#tab_option"><?php echo $tab_option; ?></a><a tab="#tab_image" style="display:none"><?php echo $tab_image; ?></a><a tab="#tab_mail"><?php echo $tab_mail; ?></a><a tab="#tab_server"><?php echo $tab_server; ?></a></div>
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <div id="tab_general">
        <table class="form">
          ...
          <tr>
            <td><span class="required">*</span> <?php echo $entry_email2; ?></td>
            <td><input type="text" name="config_email2" value="<?php echo $config_email2; ?>" size="40" />
              <?php if ($error_email2) { ?>
              <span class="error"><?php echo $error_email2; ?></span>
              <?php } ?></td>
          </tr>
          <tr>
            <td><span class="required">*</span> <?php echo $entry_email3; ?></td>
            <td><input type="text" name="config_email3" value="<?php echo $config_email3; ?>" size="40" />
              <?php if ($error_email3) { ?>
              <span class="error"><?php echo $error_email3; ?></span>
              <?php } ?></td>
          </tr>
          <tr>
      ...
      <div id="tab_wages">
        <table class="form">
	      <tr>
	        <td><?php echo $entry_minimum_bill; ?></td>
	        <td><?php if ($config_minimum_bill) { ?>
	          <input type="radio" name="config_minimum_bill" value="1" checked="checked" />
	          <?php echo $text_yes; ?>
	          <input type="radio" name="config_minimum_bill" value="0" />
	          <?php echo $text_no; ?>
	          <?php } else { ?>
	          <input type="radio" name="config_minimum_bill" value="1" />
	          <?php echo $text_yes; ?>
	          <input type="radio" name="config_minimum_bill" value="0" checked="checked" />
	          <?php echo $text_no; ?>
	          <?php } ?></td>
	      </tr>
        <tr>
        ...
        <tr>
          <td colspan="2"><h4>Tutor Pay Rate</h4></td>
        </tr>
        <tr>
          <td><span class="required">*</span> <?php echo $entry_wage_usa; ?></td>
          <td>$ <input type="text" name="wage_usa" value="<?php echo $wage_usa; ?>" />
		      <?php if (isset($error_wage_usa)) { ?>
              <span class="error"><?php echo $error_wage_usa; ?></span>
              <?php } ?></td>
        </tr>
        <tr>
          <td><span class="required">*</span> <?php echo $entry_wage_canada; ?></td>
          <td>$ <input type="text" name="wage_canada" value="<?php echo $wage_canada; ?>" />
		      <?php if (isset($error_wage_canada)) { ?>
              <span class="error"><?php echo $error_wage_canada; ?></span>
              <?php } ?></td>
        </tr>
        <tr>
          <td><span class="required">*</span> <?php echo $entry_wage_alberta; ?></td>
          <td>$ <input type="text" name="wage_alberta" value="<?php echo $wage_alberta; ?>" />
		      <?php if (isset($error_wage_alberta)) { ?>
        ...
        <table class="form">
        <tr>
          <td colspan="2"><h4>Student Invoice Rate</h4></td>
        </tr>
        <tr>
          <td><span class="required">*</span> <?php echo $entry_invoice_usa; ?></td>
          <td>$ <input type="text" name="invoice_usa" value="<?php echo $invoice_usa; ?>" />
		      <?php if (isset($error_invoice_usa)) { ?>
              <span class="error"><?php echo $error_invoice_usa; ?></span>
              <?php } ?></td>
        </tr>
        <tr>
          <td><span class="required">*</span> <?php echo $entry_invoice_canada; ?></td>
          <td>$ <input type="text" name="invoice_canada" value="<?php echo $invoice_canada; ?>" />
		      <?php if (isset($error_invoice_canada)) { ?>
              <span class="error"><?php echo $error_invoice_canada; ?></span>
              <?php } ?></td>
        </tr>
        <tr>
          <td><span class="required">*</span> <?php echo $entry_invoice_alberta; ?></td>
          <td>$ <input type="text" name="invoice_alberta" value="<?php echo $invoice_alberta; ?>" /><input type="hidden" name="wageid" value="<?=$wageid?>" />
		      <?php if (isset($error_invoice_alberta)) { ?>
...
<?php */ ?>          
      ...
      <div id="tab_subject">
        <table class="form">
          <tr>
            <td><?php echo $text_subject; ?> <input type="text" id="subject_name" name="subject_name" value="<?php echo $subject_name; ?>" /> <a onclick="add_subject();" class="button"><span><?php echo $button_add_subject; ?></span></a>
          ...
          <tr>
            ...
            <div class="scrollbox">
              ...
              <div class="<?php echo $class; ?>">
                <input type="checkbox" name="subjects[]" value="<?php echo $subject['subjects_id']; ?>" />
                <?php echo $subject['subjects_name']; ?>
              </div>
              <?php } ?>
            </div> / <a onclick="delete_subject();"><u><?php echo $button_delete_subject; ?></u></a>
            </div>
			</td>
          </tr>
        </table>
	  ...
	  <div id="tab_grade">
        <table class="form">
          <tr>
          	<td><?php echo $text_grade; ?></td>
            <td><input type="text" id="grade_name" name="grade_name" value="<?php echo $grade_name; ?>" /> <a onclick="add_grade();" class="button"><span><?php echo $button_add_grade; ?></span></a>
              <?php if ($error_grade) { ?>
              <span class="error"><?php echo $error_grade; ?></span>
              <?php } ?></td>
          </tr>        
          <tr>
            <td><?php echo $text_subjects; ?>:<div id="loader" style="float:right;display:none;"><img src="view/image/loading.gif" /></div></td>
            <td><table>
                <tr>
                  <td style="padding: 0;" colspan="3"><select id="category" name="grade_id" style="margin-bottom: 5px;" onchange="getProducts();">
                      <?php foreach ($grades as $grade) { ?>
                      <option value="<?php echo $grade['grades_id']; ?>"><?php echo $grade['grades_name']; ?></option>
                      <?php } ?>
                    </select> <a onclick="delete_grade();" class="button"><span><?php echo $button_delete_grade; ?></span></a></td>
                </tr>
                <tr>
              ...
              <input type="hidden" name="grade_subjects" value="<?php echo $grade_subjects; ?>" id="grade_subjects" />
...
<?php */ ?>          
      ...
      <div id="tab_option">
        <table class="form">
          <tr>
            <td><span class="required">*</span> <?php echo $entry_masterpassword; ?></td>
            <td><input type="text" name="config_masterpassword" value="<?php echo $config_masterpassword; ?>" size="40" />
              <?php if ($error_masterpassword) { ?>
              <span class="error"><?php echo $error_masterpassword; ?></span>
              <?php } ?></td>
          </tr>
          <tr>
...
<?php /* ?>          
          ...
          <tr>
            <td><?php echo $entry_pinvoice_prefix; ?></td>
            <td><input type="text" name="config_pinvoice_prefix" value="<?php echo $config_pinvoice_prefix; ?>" /></td>
          </tr>      
          <tr>
            <td><?php echo $entry_pinvoice_no; ?></td>
            <td><input type="text" name="config_pinvoice_no" value="<?php echo $config_pinvoice_no; ?>" /></td>
          </tr>
<?php */ ?>            
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="config_invoice_no" value="<?php echo $config_invoice_no; ?>" /></td>
          </tr>
		  <tr>
...
function delete_subject() {
	var ides=""; 
	if(confirm("Are you sure you want to delete Selected Subjects!")) {
		$('#subjects :checked').each(function() {
			
			if(ides == "")
				ides = this.value;
			else
	       		ides = ides + "," + this.value; 
	    });
		...
		if(ides == "") {
			...
			$.ajax({
				url: 'index.php?route=setting/setting/subjects&token=<?php echo $token; ?>',
				type: 'POST',
				data: 'action=delete&subject_id=' + encodeURIComponent(ides),
				dataType: 'text',
...
function edit_subject(){
	$.ajax({
		url: 'index.php?route=setting/setting/subjects&token=<?php echo $token; ?>',
		type: 'POST',
		data: 'subject_name=' + encodeURIComponent($('#subject_name').val()),
		dataType: 'text',
		success: function(data) {
...
//--></script>
<script type="text/javascript"><!--
function update_grade_subjects() {
	var ides="";
	...
	$('#grade_subjects').attr('value', ides);
}

function delete_grade() {
	ajaxStart();
	var ides=""; 
	if(confirm("Are you sure you want to delete Selected Grade!")) {
		
		ides = $('#category').attr('value');
		
		if(ides == "") {
			alert('Please select at least one Grade!');
		} else {
			$.ajax({
				url: 'index.php?route=setting/setting/grades&token=<?php echo $token; ?>',
				data: 'action=delete&grade_id=' + encodeURIComponent(ides),
				dataType: 'text',
				success: function(data) {
...
function edit_grade(){
	$.ajax({
		url: 'index.php?route=setting/setting/grades&token=<?php echo $token; ?>',
		data: 'action=update&grade_name=' + encodeURIComponent($('#grade_name').val()),
		dataType: 'text',
		success: function(data) {
			alert('Subject Updated');
		}
...
function add_grade() {
	...
	$.ajax({
		url: 'index.php?route=setting/setting/grades&token=<?php echo $token; ?>',
		data: 'action=add&grade_name=' + encodeURIComponent($('#grade_name').val()),
		dataType: 'text',
		success: function(data) {
			var grade_id = data;
			$('#category').append('<option value="' + grade_id + '">' + $('#grade_name').val() + '</option>');
			$('#grade_name').val('');
			alert('Grade Added');
			ajaxEnd();
		}
...
function getProducts() {	
	...
	$.ajax({
		url: 'index.php?route=setting/setting/grades&token=<?php echo $token; ?>&action=grade_subjects&grade_id=' + $('#category').attr('value'),
		dataType: 'json',
		success: function(data) {
			for (i = 0; i < data.length; i++) {
				if (data[i]['subjects_id'] == product_id) { continue; }
	 			$('#product').append('<option value="' + data[i]['subjects_id'] + '">' + data[i]['subjects_name'] + '</option>');
			}
...
function getRelated() {
	...
	$.ajax({
		url: 'index.php?route=setting/setting/grades&token=<?php echo $token; ?>&action=filter_subjects&grade_id=' + $('#category').attr('value'),
		dataType: 'json',
		success: function(data) {
			$('#product_related input').remove();
			
			for (i = 0; i < data.length; i++) {
	 			$('#related').append('<option value="' + data[i]['subjects_id'] + '">' + data[i]['subjects_name'] + '</option>');
			} 
