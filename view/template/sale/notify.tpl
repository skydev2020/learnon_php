        ...
        <table id="mail" border="0" class="form">
          <tr>
            ...
            <td><input type="hidden" name="store_id" value="0" /><select name="to">
                ...
                <?php } ?>
              </select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="send_email" value="yes" <?php if($send_email=="yes")echo 'checked="checked"';?> /> Send email also</td>
          </tr>
          ...
          <tr>
            ...
            <td><textarea name="message" cols="60" rows="4"><?php echo $message; ?></textarea>
