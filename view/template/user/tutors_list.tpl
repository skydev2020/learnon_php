  ...
  <div class="content">
    <form action="" method="post" enctype="multipart/form-data" id="form">
      <table class="list">
        <thead>
		  <tr>
		  	<td colspan="3">Search <input type="text" name="filter_all" value="<?php echo $filter_all; ?>" /></td>
		  	<td colspan="5" align="right" height="38">
  	<input type="checkbox" name="tutor_list" value="yes" /> Tutor list <input type="checkbox" name="tutor_emails" value="yes" /> Tutor emails <input type="checkbox" name="contract" value="yes" />  Contract/Agreement <a onclick="exportdata();" class="button"><span>Export</span></a>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="left"><?php echo $user['approved']; ?></td>
...
function filter() {
	url = 'index.php?route=user/tutors&token=<?php echo $token; ?>';
