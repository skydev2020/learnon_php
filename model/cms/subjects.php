<?php
class ModelCmsSubjects extends Model {
	public function addInformation($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "subjects SET " .
				" subjects_name = '" . $this->db->escape($data['name']) . 
	...
	public function deleteInformation($subjects_id) {
		...
		$result = $this->db->query("DELETE FROM " . DB_PREFIX . "subjects WHERE subjects_id = '" . (int)$subjects_id . "'");
